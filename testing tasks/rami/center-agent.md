...
- [ ] Log in with center agent credentials
- [ ] After login — does the dashboard show only their specific center?
- [ ] Is the center's name and location clearly displayed at the top?
- [ ] Is there no access to other centers' data anywhere in the UI?

### Edge Cases
- [ ] Copy the URL of another center's dashboard page — paste it while logged in as this agent → should be blocked or show an access denied screen
